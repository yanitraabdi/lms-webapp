...
namespace Academy.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260814052722_InvertaProgramsAndAssessments")]
    partial class InvertaProgramsAndAssessments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Academy.Domain.Entities.ScoreBandMapping", b =>
                {
                    ...
                    b.HasIndex("ProgramId", "MinRaw")
                        .HasDatabaseName("ix_score_band_mappings_program_id_min_raw");
            ...
            modelBuilder.Entity("Academy.Domain.Entities.Certificate", b =>
                {
                    ...
                    b.HasOne("Academy.Domain.Entities.Program", null)
                        .WithMany()
